...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        dataList =[[NSArray alloc]initWithArray:[QRCode allObjects]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    QRCode *qrCode = [dataList objectAtIndex:indexPath.row];
    cell.imageView.frame=CGRectMake(0, 0, 60, 60);
    cell.imageView.image=[UIImage imageWithData:qrCode.image];
    
    cell.textLabel.text=qrCode.content;
    cell.detailTextLabel.text=qrCode.codeType;
    // Configure the cell...
